...
class IMDBWIKIDataset(BasicDataset):
...
def get_imdb_wiki(args, alg, name=None, num_labels=1000, num_classes=1, data_dir='./data', include_lb_to_ulb=True):

    data_dir = os.path.join(data_dir, 'imdb_wiki')
    ...
    lb_dset = IMDBWIKIDataset(alg, lb_data, lb_targets, num_classes,
                            transform_weak, False, None, False, data_dir=data_dir)
    ulb_dset = IMDBWIKIDataset(alg, ulb_data, ulb_targets, num_classes,
                            transform_weak, True, transform_strong, False, data_dir=data_dir)
    eval_dset = IMDBWIKIDataset(alg, test_data, test_labels, num_classes,
